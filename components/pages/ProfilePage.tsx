  ...
  const dateDetail = useMemo(() => {
    ...
    return (
      <div className="px-6 -mt-6 sm:mt-0">
        ...
        <IonList>
          {listening?.positions &&
            listening?.positions.map((position, index) => {
              if (index > 2) return <></>;
              else
                return (
                  <IonItem
                    button
                    onClick={e => {
                      if (position?.episode?.slug)
                        router.push('/episode/' + position?.episode?.slug);
                    }}
            ...
            notes.map((note, index) => {
              ...
              return (
                <IonItem
                  ...
                  key={note.objectId}
                  onClick={e => {
                    if (note.episode?.slug) router.push(`/episode/${note.episode?.slug}?notes=1`);
                  }}
                >
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonTitle>
            <div
              className={`flex items-center font-bold text-lg ${isPlatform('ios') ? 'pl-6' : ''}`}
            >
              ...
              <div className="flex items-center">
                ...
                <div className="flex flex-col justify-start">
                  <div className="flex items-center justify-start">
                    ...
                    <div className="block mobile:hidden" style={{ zoom: 0.7 }}>
                      <IonChip
                        color="primary"
                        onClick={(e: any) => {
                          if (user?.objectId) {
                      ...
                      <div className="flex flex-col justify-start w-full -ml-2 text-sm tracking-tight normal-case gap-y-1">
                        <div className="flex items-center gap-x-1">
                          ...
                          <IonIcon
                            size="small"
                            icon={
                              user.nextEpisode?.publishedAt &&
                              user.nextEpisode?.publishedAt > Date.now()
                                ? timeOutline
                                : arrowForward
                            }
                            slot="end"
              ...
              <div className="hidden mobile:block">
                ...
                >
                  ...
                  {user?.objectId ? (
                    ...
                    <span className="font-bold " style={{ minWidth: '50px' }}>
                      Log in
                    </span>
                  )}
                </IonChip>
            ...
            <div className="flex w-full mt-4 mb-6 border-b justify-evenly">
              ...
              <IonButton fill="clear" onClick={() => swiperRef.slideTo(0)}>
                <div className="flex flex-col">
                  ...
                  {tabIndex === 0 && <div className="w-full h-0.5 bg-primary rounded-full"></div>}
                </div>
              </IonButton>
              ...
              <IonButton fill="clear" onClick={() => swiperRef.slideTo(1)}>
                <div className="flex flex-col">
                  ...
                  {tabIndex === 1 && <div className="w-full h-0.5 bg-primary rounded-full"></div>}
                </div>
              </IonButton>
              <IonButton fill="clear" onClick={() => swiperRef.slideTo(2)}>
                <div className="flex flex-col">
                  <span className="text-md mobile:text-lg">Pro</span>
                  {tabIndex === 2 && <div className="w-full h-0.5 bg-primary rounded-full"></div>}
                </div>
              </IonButton>
            ...
            >
                    ...
                    <div className="flex justify-center">
                      <IonDatetime
                        ...
                        highlightedDates={date => {
                          if (!dateMap) return;
                          if (dateMap.hasOwnProperty(date) && dateMap[date].listenings)
                            return {
                              textColor: '#000000',
                              backgroundColor: '#61eac8',
                            };

                          if (dateMap.hasOwnProperty(date) && dateMap[date].notes)
                            return {
                              textColor: '#000000',
                  ...
                  >
                    ...
                    {user?.isPushOn || user?.isTextOn || user?.isEmailOn ? (
                      ...
                      <span className="text-lg text-center">
                        {user?.objectId
                          ? 'Daily Reminders OFF'
                          : 'Get Daily Text, Email, Push Reminders'}
                      </span>
                    )}
              ...
              <SwiperSlide>
                <IonList>
                  {lists && lists[0] && (
                    <ListListItem
                      ...
                      onClick={e => {
                        ...
                        presentList({
                          onDidDismiss: () => {
                            setInspectedListIndex(undefined);
                          },
                        });
                      }}
                    />
                  ...
                  <div className="flex items-center justify-between w-full pt-8">
                    {user?.objectId && lists && lists.length > 1 && (
                    ...
                    {lists && lists.length > 2 && (
                      <IonButton
                        size="small"
                        fill="clear"
                        color={isReordering ? 'primary' : 'medium'}
                        onClick={() => {
                ...
                <IonList>
                  ...
                  >
                    {lists &&
                      [...lists].slice(1, lists.length).map((list, _index) => {
                        return (
                        ...
                        <div className="flex w-full">
                          ...
                          <IonButtons slot="end">
                            <IonButton
                              onClick={e => {
                                const name =
                                  typeof nameListInput.current?.value === 'string'
                                    ? nameListInput.current?.value
                                    : undefined;
              ...
              <SwiperSlide>
                <div className="flex flex-col items-center w-full px-1 pb-8">
                  {!user?.subscriptionId && (
                    <h2 className="w-full text-3xl font-bold text-left dark:text-primary text-light">
                  ...
                  {/* <div className='flex items-center justify-between w-full'>
                    <div className='flex items-center justify-between w-full'>
                      <div className='flex items-center justify-center space-x-2 text-lg font-medium'>
                        ...
                        <span className='text-sm font-bold text-medium'>{`from ${donations[1]} subscribers`}</span> 
                      </div>
                      <span className='text-sm font-medium font-bold text-medium'>
                  ...
                  <h5 className="w-full text-left">
                    <span className="font-bold">Let God&apos;s Word Be Heard!</span> Godible is only
                      ...
                      <IonButton
                        ...
                        onClick={() => {
                          ...
                          if (isPlatform('capacitor'))
                            presentPayInBrowser({ initialBreakpoint: 0.35 });
                  ...
                  <h2 className="w-full pt-12 text-2xl font-bold dark:text-dark">
                    {user?.subscriptionId
                      ? 'Thank you for your subscription'
                      : 'And Upgrade to Unlimited Access'}
                  </h2>
                  <Pricing
                    onClick={() => {
                      setReroutePath(undefined);
