import { IBook, IEpisode } from "./types";
...
export const sampleEpisodes: IEpisode[] = [
    {
        ...
        imageUrl: "https://images.unsplash.com/photo-1677817019667-606ab01d65af?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",
        book: {
            title: {
                defaultLanguage: "english",
                english: "Chambumo Gyeong"
            },
            ...
            objectId: "fdaagfda",
            authorImageUrl: "https://upload.wikimedia.org/wikipedia/commons/5/50/Rev._Sun_Myung_Moon_speaks%2C_Las_Vegas%2C_NV%2C_USA_on_April_4%2C_2010.png",

        },
        chapter: "3-3-2",
        metaData: {
            defaultLanguage: "english",
            english: "Book 3: The Beginning of True Father's Public Course and the Founding of HSA-UWC\nChapter 3: Founding the Holy Spirit Association for the Unification of World Christianity\nSection 2: The Cheongpa-dong Headquarters Church, Paragraph 02-10"
        },
        audioPath: {
            defaultLanguage: "english",
...
export const sampleBooks: IBook[] = [
    {
        ...
        tagline: {
            defaultLanguage: "english",
            english: "A volume of Holy scriptures of True Parents' words"
        },
        description: {
            defaultLanguage: "english",
            english: "The Cham Bumo Gyeong is the third volume of the Holy Scriptures after the Cheon Seong Gyeong and Pyeong Hwa Gyeong. Published on the occasion of the third anniversary of True Father’s Seonghwa, the Cham Bumo Gyeong contains True Parents’ life course described in their own words.True Father’s words sparked change in the world and have gone down in history as the most genuine and inspiring calls to center our lives on God. "
        },
        metaData: {
            defaultLanguage: "english",
            english: "Published 2010\nHarmony"
        },
        objectId: "fdaagfda",
        authorImageUrl: "https://upload.wikimedia.org/wikipedia/commons/5/50/Rev._Sun_Myung_Moon_speaks%2C_Las_Vegas%2C_NV%2C_USA_on_April_4%2C_2010.png",
        author: {
            defaultLanguage: "english",
            english: "Sun Myung Moon"
        },
        buyLink: {
            defaultLanguage: "english",
            english: "Sun Myung Moon"
        ...
        title: {
            defaultLanguage: "english",
            english: "As a Peace Loving Global Citizen"
        },
        imageUrl: "https://cdn.shopify.com/s/files/1/0267/3780/3343/files/CBG_Thumbnail_160x160.png?v=1666202514",
        slug: "cheon-bomo-gyeong",
        objectId: "fdaagfda",
        ...
        description: {
            defaultLanguage: "english",
            english: "The Cham Bumo Gyeong is the third volume of the Holy Scriptures after the Cheon Seong Gyeong and Pyeong Hwa Gyeong. Published on the occasion of the third anniversary of True Father’s Seonghwa, the Cham Bumo Gyeong contains True Parents’ life course described in their own words.True Father’s words sparked change in the world and have gone down in history as the most genuine and inspiring calls to center our lives on God. True Mother’s words are filled with the spirit of love for all God’s children and inspire the heart to know how to reach out with love. The Holy Scriptures comprise of True Parents’ most powerful sermons and speeches, including historical messages at Yankee Stadium, the Washington Monument, and more. The Cheon Seong Gyeong, Pyeong Hwa Gyeong and Cham Bumo Gyeong are now available in English as a beautiful set, holding thousands of pages of True Parents’ most profound messages. With its elegant design and wealth of spiritual enrichment, the Holy Scriptures set is a must-have for your home library."
        },
        authorImageUrl: "https://upload.wikimedia.org/wikipedia/commons/5/50/Rev._Sun_Myung_Moon_speaks%2C_Las_Vegas%2C_NV%2C_USA_on_April_4%2C_2010.png",
        author: {
            defaultLanguage: "english",
